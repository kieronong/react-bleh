...
export function useCustomFetch() {
  ...
  const updateCache = useCallback((cacheKey: string, newValue: string) => {
    ...
    cache?.current.set(cacheKey, JSON.stringify(newValue))
  }, [cache])
  ...
  return { fetchWithCache, fetchWithoutCache, updateCache, clearCache, clearCacheByEndpoint, loading }
}
